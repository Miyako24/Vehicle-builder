...
class Motorbike extends Vehicle {
    ...
    printDetails() {
        ...
        super.printDetails();
        console.log(`VIN: ${this.vin}, Make: ${this.make}, Model: ${this.model}, Year: ${this.year}, Weight: ${this.weight}kg, Top Speed: ${this.topSpeed}km/h, Color: ${this.color}, Wheels: ${this.wheels.length}`);
    }
}
