...
class Cli {
    ...
    createTruck() {
        inquirer
            ...
            .then((answers) => {
            const truck = new Truck(Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [], // Default empty array for wheels
    ...
    performActions() {
        inquirer
            ...
            if (answers.action === 'Print details') {
                ...
                const truck = this.vehicles.find(v => v.vin === this.selectedVehicleVin && v instanceof Truck);
                ...
                const motorbike = this.vehicles.find(v => v.vin === this.selectedVehicleVin && v instanceof Motorbike);
                if (motorbike instanceof Motorbike) {
                    motorbike.wheelie();
                    console.log(`${motorbike.make} ${motorbike.model} performed a wheelie!`);
                }
            }
